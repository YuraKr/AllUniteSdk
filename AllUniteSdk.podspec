...
Pod::Spec.new do |s|
  s.name             = 'AllUniteSdk'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AllUniteSdk.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/AllUniteSdk'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Yura krohmal' => 'yury.krohmal@ardas.dp.ua' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/AllUniteSdk.git', :tag => s.version.to_s }
